...
if __name__ == "__main__":
    ...
    xps_values = np.linspace(20, 100, 20)  # 71 points
    yps_values = np.linspace(20, 100, 20)
    ...
    outname = "bistability_map_xps_yps-Y-PS.dat"
...
param_sets = [(110, 70), (110, 50), (110, 30)]
...
for (xps0, yps0) in param_sets:
    ...
    out_dat = f"toggle_eigs_real_xps_{xps0}_yps_{yps0}-Y-PS.dat"
